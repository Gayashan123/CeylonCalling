...
>
      <div className="relative w-full max-w-md p-6 transition-all duration-500 ease-in-out transform bg-black rounded-lg shadow-lg shadow-white outline-1 outline-white">
        {/* Close Button */}
        <button
