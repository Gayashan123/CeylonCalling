...
const ShopForm = ({ onClose }) => {
  ...
  return (
    <AnimatePresence>
      <motion.div
        className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm px-2 sm:px-4"
      ...
      >
        <motion.div
          className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto bg-white rounded-3xl shadow-2xl p-4 sm:p-6 md:p-8 border border-gray-100 box-border"
